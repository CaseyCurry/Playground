...
(function(factory) {
  ...
  DraggableGridList.prototype = {
    ...
    _init: function() {
      ...
      this.$positionHighlight = this.$element.find('.position-highlight')
        .hide();
    ...
    _snapItemPositionToGrid: function(item) {
      ...
      position[0] -= this.$element.position()
        .left;
    ...
    addItem: function(element) {
      ...
      this._createGridSnapshot();
      this.$items = this.$element.children(this.options.itemSelector);
      const newItem = this._generateItemsFromDOM()
        .pop();
      ...
      let positionForItem = this.gridList.findPositionForItem(item, { x: 0, y: 0 });
      if (this.options.direction === "vertical") {
        positionForItem = positionForItem.reverse();
      }
      this.gridList.moveItemToPosition(item, positionForItem);
    ...
    removeItem: function(element) {
      ...
      var positionHighlight = this.$element.find('.position-highlight');
      positionHighlight.removeAttr("style");
      positionHighlight.hide();
    }
  };
